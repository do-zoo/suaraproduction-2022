...
import { footerVectorL, footerVectorR, LogoPanjangPutih } from '../../../assets'
...
function Footer() {
  return (
    <footer className='relative overflow-hidden bg-header-footer-color'>
          ...
          <div className="footer-content-item text-center md:w-[560px] px-12 md:px-0">
            ...
            <div className="footer-content-item-content">
              <p>
                ...
                located in Tangerang Selatan, Indonesia. 
                Suara Production is the leading production services company 
                for Videography, Editing, Casting, Audio 
                Post Production, and many more.
              </p>
            </div>
          </div>
          <div className="footer-content-item md:w-[560px] px-12 md:px-0">
            ...
            <div className="footer-content-item-content">
              <div className="contact-item pb-4">
                ...
                <p>
                  JL Pembangunan, No. 46, Jombang, Ciputat, Jombang, 
                  Tangerang, Kota Tangerang Selatan, Banten (15414).
                </p>
              </div>
              <div className="contact-item pb-4">
              ...
              <div className="social-item py-8 mx-auto">
                <div className="social flex px-12 gap-6 justify-center">
                  <a href="https://www.facebook.com/suaraproduction/" target="_blank" rel="noopener noreferrer">
                    <svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <circle cx="24" cy="24" r="21" fill="url(#paint0_linear_42_694)" />
                        <path
                            ...
                            fill="white" />
                        <defs>
                            <linearGradient id="paint0_linear_42_694" x1="24" y1="3" x2="24" y2="44.8754" gradientUnits="userSpaceOnUse">
                  ...
                  <a href="https://www.instagram.com/suaraproduction/" target="_blank" rel="noopener noreferrer">
                    <svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <rect x="3" y="3" width="42" height="42" rx="6" fill="url(#paint0_radial_42_693)" />
                      <rect x="3" y="3" width="42" height="42" rx="6" fill="url(#paint1_radial_42_693)" />
                      <rect x="3" y="3" width="42" height="42" rx="6" fill="url(#paint2_radial_42_693)" />
                      <path
                      ...
                      <path fillRule="evenodd" clipRule="evenodd"
                          ...
                          fill="white" />
                      <defs>
                          <radialGradient id="paint0_radial_42_693" cx="0" cy="0" r="1" gradientUnits="userSpaceOnUse"
                              gradientTransform="translate(18 34.5) rotate(-55.3758) scale(38.2794)">
                              <stop stopColor="#B13589" />
                              <stop offset="0.79309" stopColor="#C62F94" />
                              <stop offset="1" stopColor="#8A3AC8" />
                          </radialGradient>
                          <radialGradient id="paint1_radial_42_693" cx="0" cy="0" r="1" gradientUnits="userSpaceOnUse"
                          ...
                          <radialGradient id="paint2_radial_42_693" cx="0" cy="0" r="1" gradientUnits="userSpaceOnUse"
                  ...
                  <a href="https://www.youtube.com/channel/UC-_XZ-_XZ-_XZ-_XZ-_XZ-_XZ" target="_blank" rel="noopener noreferrer">
                    <svg width="48" height="45" viewBox="0 0 48 45" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path
                          ...
                          fill="#FC0D1B" />
                      <path d="M19.5 17.3301V28.3118L31.5 22.8209L19.5 17.3301Z" fill="white" />
                    </svg>
                  </a>
                </div>
              </div>
      ...
      <div className="copyright relative text-center md:py-6 py-4 bg-text-color text-main-color">SUARA PRODUCTION Media © 2021 – All rights reserved.</div> 
