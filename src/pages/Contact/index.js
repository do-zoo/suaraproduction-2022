...
function Contact() {
  return (
    <section className=" text-text-color py-16 bg-main-color">
      <div className="relative md:w-[640px] text-center mx-auto mb-16 mt-20">
      ...
      <div className="contact-us-form batas-suci flex justify-center ">
        ...
        <div className="form relative bg-main-color p-16 rounded-box flex flex-wrap gap-16 lg:gap-0 justify-center lg:justify-between">
          {/* <!-- component --> */}
              ...
              <div className="contact flex flex-none flex-wrap justify-center items-center gap-9">
                <div className="contact-item w-full flex gap-6 items-center">
                  ...
                  <div className="contact-item-text">
                    <p className="text-xl font-bold">(+62) 813-1842-3962</p>
